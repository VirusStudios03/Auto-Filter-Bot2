...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-1001850355982") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '').split()]
